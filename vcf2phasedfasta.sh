...
java -jar /ohta/apps/GenomeAnalysisTK.jar -T SelectVariants -R /ohta/felix.beaudry/assemblies/hastTranscriptome/NCF1_combined_ref_CDS_noStop.fa -V ${ind}.uni.vcf -o ${ind}.sex.vcf -L sex.list --restrictAllelesTo BIALLELIC --selectTypeToExclude INDEL
